...
<div class="w-full bg-white dark:bg-gray-800 rounded-xl shadow-sm p-5 space-y-5">
    ...
    <div>
        ...
        <div class="space-y-1">
            ...
            @php
                // Classes estáticas completas para Tailwind compilar corretamente (não usar interpolação dinâmica)
                $catStyles = [
                    'Engenharias' => [
                        'icon' => 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4',
                        'active_bg' => 'bg-blue-50 dark:bg-blue-900/20',
                        'active_text' => 'text-blue-700 dark:text-blue-300',
                        'active_icon_bg' => 'bg-white dark:bg-blue-800 shadow-sm',
                        'hover_icon_bg' => 'group-hover:bg-blue-100 dark:group-hover:bg-blue-900/40',
                        'hover_icon_text' => 'group-hover:text-blue-600',
                    ],
                    'Ciências Humanas e Sociais' => [
                        'icon' => 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253',
                        'active_bg' => 'bg-purple-50 dark:bg-purple-900/20',
                        'active_text' => 'text-purple-700 dark:text-purple-300',
                        'active_icon_bg' => 'bg-white dark:bg-purple-800 shadow-sm',
                        'hover_icon_bg' => 'group-hover:bg-purple-100 dark:group-hover:bg-purple-900/40',
                        'hover_icon_text' => 'group-hover:text-purple-600',
                    ],
                    'Área da Saúde' => [
                        'icon' => 'M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z',
                        'active_bg' => 'bg-teal-50 dark:bg-teal-900/20',
                        'active_text' => 'text-teal-700 dark:text-teal-300',
                        'active_icon_bg' => 'bg-white dark:bg-teal-800 shadow-sm',
                        'hover_icon_bg' => 'group-hover:bg-teal-100 dark:group-hover:bg-teal-900/40',
                        'hover_icon_text' => 'group-hover:text-teal-600',
                    ],
                    'Tecnologia e TI' => [
                        'icon' => 'M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4',
                        'active_bg' => 'bg-cyan-50 dark:bg-cyan-900/20',
                        'active_text' => 'text-cyan-700 dark:text-cyan-300',
                        'active_icon_bg' => 'bg-white dark:bg-cyan-800 shadow-sm',
                        'hover_icon_bg' => 'group-hover:bg-cyan-100 dark:group-hover:bg-cyan-900/40',
                        'hover_icon_text' => 'group-hover:text-cyan-600',
                    ],
                    'Conteúdos Gerais' => [
                        'icon' => 'M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4',
                        'active_bg' => 'bg-gray-100 dark:bg-gray-700',
                        'active_text' => 'text-gray-700 dark:text-gray-300',
                        'active_icon_bg' => 'bg-white dark:bg-gray-600 shadow-sm',
                        'hover_icon_bg' => 'group-hover:bg-gray-200 dark:group-hover:bg-gray-700',
                        'hover_icon_text' => 'group-hover:text-gray-700',
                    ],
                ];
                $defaultCat = [
                    'icon' => 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253',
            ...
            @foreach(\App\Enums\Course::values() as $courseName)
                @php 
                    $cat = $catStyles[$courseName] ?? $defaultCat;
                ...
                <a href="{{ request()->routeIs('favorites.index') ? route('favorites.index', ['course' => $courseName]) : route('aluno', ['course' => $courseName]) }}" 
                   class="group flex items-center justify-between p-2.5 rounded-xl transition-all duration-200 {{ $isActive ? $cat['active_bg'] . ' ' . $cat['active_text'] : 'hover:bg-gray-50 dark:hover:bg-gray-700/50 text-gray-600 dark:text-gray-400' }}">
                    <div class="flex items-center gap-3">
                        <div class="w-8 h-8 rounded-lg flex items-center justify-center transition-colors {{ $isActive ? $cat['active_icon_bg'] : 'bg-gray-100 dark:bg-gray-800 ' . $cat['hover_icon_bg'] . ' ' . $cat['hover_icon_text'] }}">
