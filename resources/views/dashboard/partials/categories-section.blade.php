...
<div>
    ...
    <div class="flex gap-3 mb-6 flex-wrap">
        <button @click="activeCategory = 'all'" 
                :class="activeCategory === 'all' ? 'bg-indigo-600 text-white' : 'bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300'"
                class="category-pill px-6 py-2 rounded-full font-medium transition-colors">
            All
        </button>
        <button @click="activeCategory = 'engineering'" 
                :class="activeCategory === 'engineering' ? 'bg-indigo-600 text-white' : 'bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300'"
                class="category-pill px-6 py-2 rounded-full font-medium transition-colors">
            Engineering
        </button>
        <button @click="activeCategory = 'business'" 
                :class="activeCategory === 'business' ? 'bg-indigo-600 text-white' : 'bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300'"
                class="category-pill px-6 py-2 rounded-full font-medium transition-colors">
            Business
        </button>
        <button @click="activeCategory = 'education'" 
                :class="activeCategory === 'education' ? 'bg-indigo-600 text-white' : 'bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300'"
                class="category-pill px-6 py-2 rounded-full font-medium transition-colors">
            Education
        </button>
        <button @click="activeCategory = 'health'" 
                :class="activeCategory === 'health' ? 'bg-indigo-600 text-white' : 'bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300'"
                class="category-pill px-6 py-2 rounded-full font-medium transition-colors">
            Health
        </button>
    </div>
