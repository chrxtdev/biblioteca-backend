<x-layouts.auth-split>
    <div class="mb-8">
        <h2 class="mt-6 text-3xl font-bold tracking-tight text-gray-900">Área Segura 🛡️</h2>
    ...
    <form method="POST" action="{{ route('password.confirm') }}" class="space-y-6">
        ...
        <div x-data="{ show: false }">
            ...
            <div class="mt-1 relative rounded-md shadow-sm">
                ...
                <input id="password" name="password" type="password" :type="show ? 'text' : 'password'" required autocomplete="current-password" autofocus
